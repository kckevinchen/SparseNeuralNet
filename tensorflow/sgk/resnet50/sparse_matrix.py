...
class SparseMatrix(object):
  ...
  def __init__(self,
    ...
    self._dtype = dtype
    self._nnz = np.count_nonzero(matrix)
    self._sparsity = 1.0 - self._nnz / matrix.size
    ...
    if(layer != None):
      layer._trainable_weights.append(self._values)
      layer._non_trainable_weights.append(self._row_indices)
      layer._non_trainable_weights.append(self._row_offsets)
      layer._non_trainable_weights.append(self._column_indices)
