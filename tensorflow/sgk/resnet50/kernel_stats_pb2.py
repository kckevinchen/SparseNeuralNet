...
KernelReport = _reflection.GeneratedProtocolMessageType('KernelReport', (_message.Message,), dict(
  DESCRIPTOR = _KERNELREPORT,
  __module__ = 'kernel_stats_pb2'
  # @@protoc_insertion_point(class_scope:tensorflow.profiler.KernelReport)
  ))
_sym_db.RegisterMessage(KernelReport)

KernelStatsDb = _reflection.GeneratedProtocolMessageType('KernelStatsDb', (_message.Message,), dict(
